...
export const CategoryFormEdit = ({onClose, category}: CategoryFormProps) => {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
          ...
          try {
              const response = await patch<Category, CreateCategory>(`/categories/${category?.id}`, {name, description})
                ...
                <div className="mb-6 flex items-start justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-slate-500">
                            Edit a category to organize your products.
                        </p>
                    </div>
