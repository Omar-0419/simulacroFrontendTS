...
import type { Product, CreateProduct, ProductFormProps } from "../../types/interfaces"

import { useState } from "react"

export const ProductFormEdit = ({ onClose, product }: ProductFormProps) => {
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            const response = await patch<Product, CreateProduct>(`/products/${product?.id}`, {
                name,
                description,
                price,
                stock,
                ...
                <div className="flex items-center justify-between border-b border-slate-100 px-8 py-6">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                            Complete the information to edit a product to your inventory.
                        </p>
                    </div>
