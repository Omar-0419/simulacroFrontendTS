        ...
        {categories.map((category) => (
          ...
          >
            ...
            <div className="mt-6 border-t border-slate-100 pt-4 flex justify-between items-center">
              ...
              <div>
                <button className="w-15 m-1  rounded-lg cursor-pointer text-red-400 border border-red-400 hover:bg-red-400 hover:text-amber-50">Delete</button>
                <button className="border border-amber-400 w-15 m-1 text-amber-400 rounded-lg cursor-pointer hover:bg-amber-400 hover:text-amber-50">Edit</button>
              </div>
            </div>
          </Link>
        ))}
